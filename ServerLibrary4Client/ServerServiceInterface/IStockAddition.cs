...
{    
    ...
    public interface IStockAddition
    {
        ...
        [OperationContract]
        List<CStockAdditionReportSummary> FindStockAdditionSummary(DateTime startDate, DateTime endDate, string billType, string billNo, string productCode, string product, string narration, string financialCode);
        [OperationContract]
        List<CStockAdditionReportDetailed> FindStockAdditionDetailed(DateTime startDate, DateTime endDate, string billType, string billNo, string productCode, string product, string narration, string financialCode);
    }
